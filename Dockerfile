...
# https://github.com/espressif/esp-idf/blob/v3.2-beta1/docs/en/get-started/linux-setup.rst
#
# ESP-IDF v3.2-beta1
# https://github.com/espressif/esp-idf/blob/v3.2-beta1/docs/en/get-started/index.rst#get-esp-idf
#
# Author: Larry Li
...
RUN git clone -b v3.2-beta1 --depth 1 --recursive https://github.com/espressif/esp-idf.git $IDF_PATH \
