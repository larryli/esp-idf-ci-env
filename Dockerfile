...
# https://docs.espressif.com/projects/esp-idf/en/v3.1.3/get-started/linux-setup.html
#
# ESP-IDF v3.1.3
# https://docs.espressif.com/projects/esp-idf/en/v3.1.3/get-started/index.html#get-esp-idf
#
# Author: Larry Li
...
RUN git clone -b v3.1.3 --depth 1 --recursive https://github.com/espressif/esp-idf.git $IDF_PATH \
