...
# https://github.com/espressif/esp-idf/blob/v3.3-beta2/docs/en/get-started/linux-setup.rst
#
# ESP-IDF v3.3-beta2
# https://github.com/espressif/esp-idf/blob/v3.3-beta2/docs/en/get-started/index.rst#get-esp-idf
#
# Author: Larry Li
...
RUN git clone -b v3.3-beta2 --depth 1 --recursive https://github.com/espressif/esp-idf.git $IDF_PATH
