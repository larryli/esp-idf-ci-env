...
# https://docs.espressif.com/projects/esp-idf/en/v3.2-rc/get-started/linux-setup.html
#
# ESP-IDF v3.2-rc
# https://docs.espressif.com/projects/esp-idf/en/v3.2-rc/get-started/index.html#get-esp-idf
#
# Author: Larry Li
...
RUN git clone -b v3.2-rc --depth 1 --recursive https://github.com/espressif/esp-idf.git $IDF_PATH \
